...
/*$doc = phpQuery::newDocumentHTML($s);
        ...
        return $path;
 * */
$html = file_get_contents("https://www.oschina.net/project/lang/22/php");
$data= QueryList::Query($html,array(
    "title"=>array(".project-item h3.header","text",'',function($str){
        $str=str_replace("国","",$str);
return preg_replace("/ /","",$str);
    }),
        "href"=>[".project-item h3.header a","href"]
    )
)->getData();
dump($data);
